...
plotDistribution (TrapezoidalPlateau(2.0, 8.0, 3.0)) "TrapezoidalPlateau Distribution (2,8,3)" "trapezoidalplateau_fixed.png"n from the project root: dotnet fsi scripts/test_fixed_trapezoidal_viz.fsx
